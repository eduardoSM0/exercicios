...
console.log("ordem crescente é: " +number1, +number2, +number3);
}
if (number1<number2 && number1<number3 && number3<number2){
console.log("ordem crescente é: " +number1, +number3, +number2);
}
if(number2<number1 && number2<number3 && number1<number3) {
console. log("ordem crescente é: " +number2, +number1, +number3);
}
if (number2<number1 && number2<number3 && number3<number1) {
console. log("ordem crescente é: " +number2, +number3, +number1);
}
...
console.log("ordem crescente e: " +number3, +number1, +number2);